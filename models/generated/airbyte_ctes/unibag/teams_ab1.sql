...
select
    ...
    {{ json_extract('table_alias', '_airbyte_data', ['level'], ['level']) }} as {{ adapter.quote('level') }},
    ...
    {{ json_extract('table_alias', '_airbyte_data', ['information'], ['information']) }} as information,
