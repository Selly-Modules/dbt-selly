...
-- depends_on: {{ ref('product_categories_icon_dimensions') }}
select
...
from {{ ref('product_categories_icon_dimensions') }} as table_alias
-- sm at product-categories/icon/dimensions/sm
where 1 = 1
and sm is not null
