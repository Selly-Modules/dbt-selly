...
select
    ...
    {{ json_extract('table_alias', '_airbyte_data', ['order'], ['order']) }} as {{ adapter.quote('order') }},
    {{ json_extract('table_alias', '_airbyte_data', ['price'], ['price']) }} as price,
    {{ json_extract('table_alias', '_airbyte_data', ['score'], ['score']) }} as score,
    ...
    {{ json_extract_scalar('_airbyte_data', ['displaySKUId'], ['displaySKUId']) }} as displayskuid,
    {{ json_extract_scalar('_airbyte_data', ['isOutOfStock'], ['isOutOfStock']) }} as isoutofstock,
    {{ json_extract('table_alias', '_airbyte_data', ['pricePercent'], ['pricePercent']) }} as pricepercent,
    ...
    {{ json_extract('table_alias', '_airbyte_data', ['reviewStatistic'], ['reviewStatistic']) }} as reviewstatistic,
