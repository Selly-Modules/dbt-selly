...
-- depends_on: {{ ref('products_info_inventory') }}
select
    ...
    {{ json_extract_scalar(adapter.quote('location'), ['provinceName'], ['provinceName']) }} as provincename,
    _airbyte_ab_id,
    _airbyte_emitted_at,
    {{ current_timestamp() }} as _airbyte_normalized_at
from {{ ref('products_info_inventory') }} as table_alias
